    ...
    <div className="min-h-screen bg-[#0a0a0f]">
      ...
      <main className="mx-auto max-w-2xl px-4 py-6">
        <form onSubmit={handleSubmit} className="space-y-6">
                ...
                >
                  <cat.icon
                    className={`h-5 w-5 mb-2 ${
                      category === cat.key ? "text-emerald-400" : "text-zinc-500"
                    }`}
                  />
                  <p
                    className={`text-sm font-semibold ${
                      category === cat.key ? "text-white" : "text-zinc-400"
                    }`}
                  >
                    {cat.label}
                  </p>
          ...
          {/* Server */}
          <div className="space-y-2">
            <Label htmlFor="server" className="text-sm font-medium text-zinc-300">
              服务器
            </Label>
            <Input
              id="server"
          ...
          <div className="space-y-3">
            ...
            <div className="flex gap-3">
              <Select
                value={contactType}
                onValueChange={(v: "wechat" | "qq") => setContactType(v)}
              >
              ...
              <Input
                ...
                placeholder={contactType === "wechat" ? "微信号" : "QQ号"}
                maxLength={200}
